...
class GameWindow(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        # 1 sec after the game running changes the screen once
        Clock.schedule_once(self.fix_full_screen, 1)
    ...
    # my workaround about buildozer full screen problem. When buildozer full screen is enabled my app go to black
    # screen right after pre-splash img. I do single call of this func and move from the filler screen to main screen
    def fix_full_screen(self, *args):
